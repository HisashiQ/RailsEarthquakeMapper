...
class EarthquakesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create earthquake" do
    assert_difference('Earthquake.count') do
      post earthquakes_url, params: { earthquake: { apiID: @earthquake.apiID, latitude: @earthquake.latitude, longitude: @earthquake.longitude, mag: @earthquake.mag, place: @earthquake.place } }
    end
  ...
  test "should update earthquake" do
    patch earthquake_url(@earthquake), params: { earthquake: { apiID: @earthquake.apiID, latitude: @earthquake.latitude, longitude: @earthquake.longitude, mag: @earthquake.mag, place: @earthquake.place } }
